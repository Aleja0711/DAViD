...
document.getElementById("service-next").onclick = function(){
    ...
    document.getElementById("service-title").innerHTML=(ourServices[seleccionado,title]);  
    document.getElementById("service-text").innerHTML=(ourServices[seleccionado,text]);  
